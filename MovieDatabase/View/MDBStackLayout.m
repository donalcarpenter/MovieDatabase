...
- (void)prepareLayout
{
    ...
    for (NSInteger j = 0; j < sectionCount; j++) {
        ...
        for (NSInteger i = 0; i < itemCount; i++) {
            ...
            itemAttributes.zIndex = PhotoCellBaseZIndex + itemCount - i;
            ...
            UICollectionViewLayoutAttributes *titleAttributes = [UICollectionViewLayoutAttributes
                                                                 layoutAttributesForSupplementaryViewOfKind:StackLayoutSectionKind
    ...
    self.layoutInfo = @{FMStackLayoutCellKind: cellLayoutInfo, StackLayoutSectionKind: titleLayoutInfo};
}
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    return self.layoutInfo[FMStackLayoutCellKind][indexPath];
}

- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)kind
                                                                     atIndexPath:(NSIndexPath *)indexPath
{
    return self.layoutInfo[StackLayoutSectionKind][indexPath];
}
